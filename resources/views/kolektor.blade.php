...
<link rel="stylesheet" herf="https://cdn.datatables.net/1.10.25/css/dataTables.bootstrap4.min.css" > -->
		...
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="active">
						<a href="{{ url('homekolektor') }}"> <i class="menu-icon fa fa-dashboard"></i>Home </a>
					</li>
					<h3 class="menu-title">Data Personalia</h3>
					<li class="menu-item-has-children dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-user"></i>Data Debitur</a>
						<ul class="sub-menu children dropdown-menu">
							<li><i class="fa fa-user"></i><a href="{{ url('debiturkol/'. Auth::guard('kolektor')->user()->id) }}">Debitur</a></li>
							<!-- <li><i class="fa fa-plus"></i><a href="{{ url('ddebiturkol') }}">Tabel Debitur</a></li> -->
						</ul>
					</li>
					<li class="menu-item-has-children dropdown">
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="fa fa-briefcase"></i><a href="{{ url('dagunankol') }}">Tabel Agunan</a></li>
					...
					<li class="menu-item-has-children dropdown">
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li><i class="fa fa-map-marker"></i><a href="{{ url('coordkol') }}">Update kordinat kolektor</a></li>
							<li><i class="fa fa-map-marker"></i><a href="{{ url('gmap') }}">Maps Informasi</a></li>
			...
			<div class="header-menu">
				...
				<div class="col-sm-5">
					<div class="user-area dropdown float-right">
						...
						Hallo Kolektor {{ auth::guard('kolektor')->user()->name }}

						</a>
						<div class="user-menu dropdown-menu">
							
							<!-- <a class="nav-link" href="#"><i class="fa fa -cog"></i>Settings</a> -->
							<a class="nav-link" href="{{ url('logoutkol') }}"><i class="fa fa-power -off"></i>Logout</a>
						</div>
					</div>
