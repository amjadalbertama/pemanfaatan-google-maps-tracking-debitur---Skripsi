			...
			<div class="card card0">
				<div class="d-flex flex-lg-row flex-column-reverse">
                    ...
                    <div id="button" class="btn-left">
						<a class="btn btn-white" href="{{ url('/loginadmin') }}">Login Super Admin</a>
						<!-- <a class="btn btn-white" href="#">Login Kolektor</a> -->
						...
						<div class="row justify-content-center my-auto">
							<div class="col-md-8 col-10 my-5">
								<div class="row justify-content-center px-3 mb-3"> <img id="logo" src="{{ asset('style/images/logoorang.png') }}"> </div>
								<h3 class="mb-5 text-center heading">Murni Finance</h3>
								<h5 class="msg-info">Login Kolektor</h5>
								@if(session('loginkol'))
                                ...
                                @endif
                                <form action="{{route('loginpostkolektor')}}" method="POST">
                                    @csrf
						...
						<div class="bottom text-center mb-5">
							<!-- <p href="" class="sm-text mx-auto mb-3">Don't have an account?<a href="{{ url('/registerkol') }}"><button class="btn btn-white ml-2">Create new</button></a></p> -->
							<br><br><br>
						</div>
					</div>
