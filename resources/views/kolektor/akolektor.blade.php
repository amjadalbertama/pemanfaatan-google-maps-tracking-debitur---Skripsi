			...
			<div class="page-title">
				<ol class="breadcrumb text-right">
					<!-- <li class="active">
						...
						<a href="#" title="You're here"> Add Kolektor</a>
					</li> -->
				</ol>
			</div>
		</div>
			...
			<div class="card-body">
				...
				<!-- <div id="map" style=" width: 80% ; height: 400px; margin-bottom: 20px; margin-right: 20px;"></div> -->
					<div class="col-md-4 offset-md-1">
						<form action="{{ url('dKolektors') }}" method="post">
						@csrf
							<div class="form-group">
								<label>Nama Dept Collector</label>
							...
							<div class="form-group">
								...
								<input type="text" name="kolektor_nomor" class="form-control @error('kolektor_nomor') is-invalid @enderror" value="{{ old('kolektor_nomor') }}" required>
								@error('Kolektor_nomor')
								<div class="invalid-feedback">{{ $message }}</div>
								@enderror
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="email" name="kolektor_email" class="form-control @error('kolektor_email') is-invalid @enderror" value="{{ old('kolektor_email') }}" required>
								@error('kolektor_email')
								<div class="invalid-feedback">{{ $message }}</div>
								@enderror
							</div>
							<div class="form-group">
                            <label> Status </label>
							<select type="text" class="form-control @error('kolektor_status') is-invalid @enderror" name="kolektor_status" required>
