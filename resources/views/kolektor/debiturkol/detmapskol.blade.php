				...
				<div id="map" style=" width: 60% ; height: 660px; margin-bottom: 20px; margin-right: 20px;">
					...
					<form action="{{ url('dKolektor/'. Auth::guard('kolektor')->user()->id) }}" method="post">
						...
						<div class="form-grup">
							...
							<input type="text" class="form-control" id="latitude" name="Latitude" value="{{ Auth::guard('kolektor')->user()->latitude }}">
						</div>	

						<div class="form-grup">	
							<label><h5>-> Longitude</h5>  </label>
							<input type="text" class="form-control"  id="longitude" name="Longitude" value="{{ Auth::guard('kolektor')->user()->longitude }}">
						</div>
						<?php
